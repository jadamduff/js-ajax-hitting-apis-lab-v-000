...
function displayRepositories() {
  ...
  for (var i = 0; i < repos.length; i++) {
    repoList += '<li><a href="' + repos[i]['html_url'] + '">' + repos[i]['name'] + '</a> <a href="#" data-repository="' + repos[i]['name'] + '" data-username="' + repos[i]['name'] + '" onclick="getCommits(this)">Commits</a></li>';
  }
  repoList += '</ul>';
